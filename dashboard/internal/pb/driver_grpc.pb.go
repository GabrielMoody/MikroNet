...
type DriverServiceClient interface {
	...
	GetDriverDetails(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Driver, error)
}
...
func (c *driverServiceClient) GetDriverDetails(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Driver, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Driver)
...
type DriverServiceServer interface {
	...
	GetDriverDetails(context.Context, *Empty) (*Driver, error)
...
func (UnimplementedDriverServiceServer) GetDriverDetails(context.Context, *Empty) (*Driver, error) {
...
func _DriverService_GetDriverDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServiceServer).GetDriverDetails(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
