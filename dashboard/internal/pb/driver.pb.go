...
var file_driver_proto_rawDesc = []byte{
	...
	0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22,
	0x22, 0x0a, 0x10, 0x52, 0x65, 0x71, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x02, 0x69, 0x64, 0x22, 0x36, 0x0a, 0x07, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x73, 0x12, 0x2b,
	...
	0x65, 0x72, 0x52, 0x07, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x73, 0x32, 0x8b, 0x01, 0x0a, 0x0d,
	0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x34, 0x0a,
...
var file_driver_proto_goTypes = []any{
	...
	(*Empty)(nil),            // 1: dashboard.Empty
	(*ReqDriverDetails)(nil), // 2: dashboard.ReqDriverDetails
	(*Drivers)(nil),          // 3: dashboard.Drivers
}
var file_driver_proto_depIdxs = []int32{
	0, // 0: dashboard.Drivers.drivers:type_name -> dashboard.Driver
	1, // 1: dashboard.DriverService.GetDrivers:input_type -> dashboard.Empty
	2, // 2: dashboard.DriverService.GetDriverDetails:input_type -> dashboard.ReqDriverDetails
	3, // 3: dashboard.DriverService.GetDrivers:output_type -> dashboard.Drivers
	0, // 4: dashboard.DriverService.GetDriverDetails:output_type -> dashboard.Driver
