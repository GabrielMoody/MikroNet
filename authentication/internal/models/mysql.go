...
func DatabaseInit() *gorm.DB {
	...
	dsn := fmt.Sprintf("%s:%s@tcp(%s:%s)/%s?charset=utf8mb4&parseTime=True", v.GetString("MYSQL_USERNAME"), v.GetString("MYSQL_PASS"), v.GetString("MYSQL_HOST"), v.GetString("MYSQL_PORT"), v.GetString("MYSQL_DATABASE"))
