...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.DriverID = field.NewString(tableName, "driver_id")
	_order.PickupLocation = field.NewString(tableName, "pickup_location")
	_order.DropOffLocation = field.NewString(tableName, "drop_off_location")
...
func (o *order) updateTableName(table string) *order {
	...
	o.DriverID = field.NewString(table, "driver_id")
	o.PickupLocation = field.NewString(table, "pickup_location")
	o.DropOffLocation = field.NewString(table, "drop_off_location")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["driver_id"] = o.DriverID
	o.fieldMap["pickup_location"] = o.PickupLocation
	o.fieldMap["drop_off_location"] = o.DropOffLocation
