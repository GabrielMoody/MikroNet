...
func newDriver(db *gorm.DB, opts ...gen.DOOption) driver {
	...
	_driver.ID = field.NewString(tableName, "id")
	_driver.OwnerID = field.NewString(tableName, "owner_id")
	_driver.RouteID = field.NewString(tableName, "route_id")
	_driver.RegistrationNumber = field.NewString(tableName, "registration_number")
	_driver.Status = field.NewString(tableName, "status")
	_driver.AvailableSeats = field.NewInt32(tableName, "available_seats")
...
func (d *driver) updateTableName(table string) *driver {
	...
	d.RouteID = field.NewString(table, "route_id")
	d.RegistrationNumber = field.NewString(table, "registration_number")
	d.Status = field.NewString(table, "status")
	d.AvailableSeats = field.NewInt32(table, "available_seats")
...
func (d *driver) fillFieldMap() {
	...
	d.fieldMap["route_id"] = d.RouteID
	d.fieldMap["registration_number"] = d.RegistrationNumber
	d.fieldMap["status"] = d.Status
	d.fieldMap["available_seats"] = d.AvailableSeats
